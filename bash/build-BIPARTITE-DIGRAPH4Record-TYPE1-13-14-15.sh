...
#!/bin/bash
#
# $0 = build-BIPARTITE-DIGRAPH4Record-TYPE1-13-14-15.sh
...
#
# ./build-BIPARTITE-DIGRAPH4Record-TYPE1-13-14-15.sh $KAG_extract Set-A Set-B DecodeTable >> $KAG_outputfile 
#
# -------------------------------------------------------------
...
printf "BIPARTITE DIGRAPH TYPE1\n"
for i in `cat $2`
do
  for j in `cat $3`
  do
